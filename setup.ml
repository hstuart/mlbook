...
(* OASIS_START *)
(* DO NOT EDIT (digest: 74a2969fcae033178b490103264119b8) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Henrik Stuart <hg@hstuart.dk>"];
          homepage = Some "https://github.com/hstuart/mlbook";
          bugreports = None;
          synopsis = "A variant of gitbook written in OCaml";
          description = Some [OASISText.Para "Foo"];
          tags = [];
          categories = [];
          files_ab = [];
          sections =
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "mlbook.ml"})
            ];
     ...
     oasis_digest = Some "\140\210\230\254\011%\028p\161\031cp\236\026y\199";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
